...
| `STREAM_TIMEOUT_MS`             | Timeout between real streaming chunks, in milliseconds. Maximum: `3000000`.                                                                                                                                                                                          | `60000`   |
| `FAKE_STREAM_TIMEOUT_MS`        | Timeout for fake streaming / non-streaming buffered responses, in milliseconds. Maximum: `3000000`.                                                                                                                                                                  | `3000000` |
